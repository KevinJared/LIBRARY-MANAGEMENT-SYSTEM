        ...
        <div class="wrapper">
            <div class="container">
                <div class="row">
                    ...
                    <!--/.span3-->
                    <div class="span9">
                    <div><h1>CURRENTLY BORROWED BOOKS</h1></div>
                        <form class="form-horizontal row-fluid" action="current.php" method="post">
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from welcome.record,welcome.book where RollNo = '$rollno' and Date_of_Issue is NOT NULL and Date_of_Return is NULL and book.Bookid = record.BookId and (record.BookId='$s' or Title like '%$s%')";

                                        }
                                    else
                                        $sql="select * from welcome.record,welcome.book where RollNo = '$rollno' and Date_of_Issue is NOT NULL and Date_of_Return is NULL and book.Bookid = record.BookId";
