...
<body>
    ...
    <div class="container w3-container w3-teal">
    ...
    <div class="register">
        ...
        <form action="index.php" method="post">
            ...
            <select name="Category" id="Category" style="color:black">
                ...
                <option value="OBC">1st YEAR</option>
                <option value="SC">2nd YEAR</option>
                <option value="ST">3rd YEAR</option>
                <option value="GEN">4th YEAR</option>
            </select>
            <br>
...
//  $c=$_POST['Category'];
 ...
 $sql="select * from welcome.user where RollNo='$u'";
...
if(isset($_POST['signup']))
{
	...
	$sql="insert into welcome.user (Name,Type,Category,RollNo,EmailId,MobNo,Password) values ('$name','$type','$category','$rollno','$email','$mobno','$password')";
